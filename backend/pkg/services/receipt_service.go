...
func (s *ReceiptService) GenerateOutgoingRemittanceReceipt(tenantID, remittanceID uint) ([]byte, error) {
	...
	data := ReceiptData{
		...
		SendAmount:      remittance.AmountIRR,
		SendCurrency:    "IRR",
		ReceiveAmount:   remittance.ReceivedCAD,
		ReceiveCurrency: "CAD",
		ExchangeRate:    remittance.BuyRateCAD,
		Fee:             remittance.FeeCAD,
		FeeCurrency:     "CAD",
		TotalPaid:       remittance.ReceivedCAD,
		TotalCurrency:   "CAD",
...
func (s *ReceiptService) GenerateIncomingRemittanceReceipt(tenantID, remittanceID uint) ([]byte, error) {
	...
	data := ReceiptData{
		...
		SendAmount:      remittance.AmountIRR,
		SendCurrency:    "IRR",
		ReceiveAmount:   remittance.EquivalentCAD,
		ReceiveCurrency: "CAD",
		ExchangeRate:    remittance.SellRateCAD,
		Fee:             remittance.FeeCAD,
		FeeCurrency:     "CAD",
		TotalPaid:       remittance.PaidCAD,
		TotalCurrency:   "CAD",
		QRCodeData:      fmt.Sprintf("remittance:%s", remittance.RemittanceCode),
	}
